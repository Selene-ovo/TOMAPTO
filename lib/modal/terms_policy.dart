  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.separated(
        itemCount: AppTermsData.allTerms.length,
        separatorBuilder: (context, index) => const SizedBox(height: 1),
        itemBuilder: (context, index) {
          final termsItem = AppTermsData.allTerms[index];
          return _buildListItem(
            context, 
            termsItem.title,
            () => TermsModal.show(context, termsItem),
          );
        },
      ),
    );
...
class TermsModal {
  /// 이용약관 모달을 표시합니다.
  static void show(BuildContext context, TermsModalData data) {
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return _TermsModalContent(data: data);
      },
    );
  }
}
...
/// 앱에서 사용하는 모든 이용약관 데이터
class AppTermsData {
  // 서비스 이용약관
  static const TermsModalData serviceTerms = TermsModalData(
    title: '서비스 이용약관 동의',
    content: '제 1 조 (목적)\n'
  ...
  // 개인정보 수집 및 이용
  static const TermsModalData privacyCollection = TermsModalData(
    title: '개인정보 수집 및 이용',
  ...
  // 개인정보처리방침
  static const TermsModalData privacyPolicy = TermsModalData(
    title: '개인정보처리방침',
  ...
  // 네이버 위치기반 서비스 이용약관
  static const TermsModalData naverLocationTerms = TermsModalData(
    title: '네이버 위치기반 서비스 이용약관',
    content: '제 1 조 (목적)\n'
  ...
  // 법적 공지 / 정보 제공처
  static const TermsModalData legalNotice = TermsModalData(
    title: '법적 공지 / 정보 제공처',
    content: '저작권 정보\n'
  ...
  // 모든 약관 목록
  static const List<TermsModalData> allTerms = [
    serviceTerms,
    privacyCollection,
    privacyPolicy,
    naverLocationTerms,
